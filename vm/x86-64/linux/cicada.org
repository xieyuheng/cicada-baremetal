...
* load-core-file & Initial-files-to-load
  #+begin_src fasm :tangle cicada.fasm
  defCode "load-core-file", load_core_file
     ;; (* -- *)
...
** read-char
   ...
   defConst "Size-of-input-buffer",  Size_of_input_buffer,  TheSize_of_input_buffer
   defConst "Input-buffer",          InputBuffer,        TheInputBuffer
   defConst "End-of-input-buffer",   End_of_input_buffer,   _End_of_input_buffer
   ...
   ;;    an example of ``ReadingBoundary'' is ``End_of_input_buffer''
...
** print-string
   #+begin_src fasm :tangle cicada.fasm
   defWord "print-string", print_string
...
** User_data_area
   ...
   defConst "User-data-area", User_data_area, _User_data_area
   defConst "End-of-user-data-area", End_of_user_data_area, _End_of_user_data_area
   #+end_src
