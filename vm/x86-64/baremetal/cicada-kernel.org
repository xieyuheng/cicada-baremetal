...
*** inputChar
    ...
    ;;    xx inputChar, writeChar, _branch, -3
    ;;    xx Exit
...
*** inputLine
    ...
    defWord "input-line", inputLine
       ...
       xx _literal, '_', writeChar, decrementCursor
       ...
       xx   _literal, ' ', writeChar, decrementCursor
...
*** read_char
    ...
    defWord "not-reading-from-input-buffer?", notReadingFromInputBuffer?
       ;; (* -- True of False *)
       xx CurrentReading, fetch
       xx TheEndOfInputBuffer, greater_than?, _false?branch, 3
       xx   True
       xx   Exit
       xx CurrentReading, fetch
