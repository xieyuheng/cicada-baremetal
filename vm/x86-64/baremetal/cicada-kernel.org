...
*** inputChar
    ...
    defWord "input-char", inputChar
       ...
       xx dup, literal, 128, greater_than?, false?branch, 4
...
*** read_char
    ...
    defWord "not-reading-from-input-buffer?", notReadingFromInputBuffer?
       ;; (* -- True of False *)
       xx CurrentReading, fetch
       xx TheEndOfInputBuffer, greater_than?, false?branch, 3
       xx   True
       xx   Exit
       xx CurrentReading, fetch
       xx TheInputBuffer, less_than?, false?branch, 3
       xx   True
       xx   Exit
       xx False
       xx Exit
...
*** Cursor
    ...
    defWord "increment-cursor", incrementCursor
       ...
       xx   Exit
       xx One, getCurrentCursorAddress, add_save
       xx Exit
    ...
    defWord "decrement-cursor", decrementCursor
       ...
       xx   Exit
       xx One, getCurrentCursorAddress, sub_save
       xx Exit
