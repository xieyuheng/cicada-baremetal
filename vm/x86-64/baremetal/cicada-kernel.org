...
*** note
    ...
    - read_char
      ...
      read_char 的特点在于
      这个函数所读写的地方取决于
      [CurrentReading + Cell_width] 和 [ReadingBoundary + Cell_width] 这两个全局变量
...
*** read_char
    ...
    defConst "End-of-input-buffer",   End_of_input_buffer,   TheEnd_of_input_buffer
    ...
    defWord "read-char", read_char
       ...
       xx   CurrentReading, fetch, fetch_byte
       xx   _literal, 1, CurrentReading, add_save
       xx   Exit
       ;; all chars in InputBuffer
       ;; (or any other buffer) have been processed
       xx notReadingFromInputBuffer?, _false?branch, 5
       ...
       ;; and loop back
       xx toReadFromInputBuffer
       xx TheInputBuffer, TheSize_of_input_buffer
       xx openInterrupt
       xx inputLine
       xx closeInterrupt
       ;; set ReadingBoundary ==
       ;;     InputBuffer + length of string that was inputed
       xx ReadingBoundary, add_save
       xx drop
       xx _branch, -31
    defWordEnd read_char
    ...
    defWord "not-reading-from-input-buffer?", notReadingFromInputBuffer?
       ...
       xx   Exit
       xx CurrentReading, fetch
       xx TheInputBuffer, less_than?, _false?branch, 3
       xx   True
       xx   Exit
       xx False
       xx Exit
...
*** ScreenBuffer
    ...
    defCode "scroll-screen-buffer", scrollScreenBuffer
       ...
       mov bl, byte [DefaultBackColorOfChar + Cell_width]
       shl bl, 4
       mov ah, byte [DefaultForeColorOfChar + Cell_width]
       or ah, bl
       mov al, ' '
       mov cx, 80
...
*** putCharWithColor & putChar
    ...
    defCode "put-char-with-color", putCharWithColor
       ...
       mov rdx, [CurrentScreenBuffer + Cell_width]
       mov ax, [rdx - 8]
...
*** write_char_with_color & write_char
    #+begin_src fasm :tangle cicada-kernel.fasm
    defWord "write-char-with-color", write_char_with_color
       ;; (* char, back color, fore color --  *)
       ...
       xx incrementCursor
       xx Exit
    defWordEnd write_char_with_color


    defWord "write-char", write_char
       ;; (* char --  *)
