...
** the basic lexicographer
   ...
   defWord "help:append-word-description-to-here,literal&branch", help_append_word_description_to_here_literal_branch
      ...
      xx dup2, stringDenoteNumber?, false?branch, 5
      xx   number, drop, appendNumberToHere
      xx   Exit
      xx help_append_word_description_to_here_word
      xx Exit
...
*** number
    ...
    number_helperFunction:
       ...
       pushArgumentStack rax     ;; top of ArgumtStack == 0, indicating positive
       cmp bl, '-'
       ;-- IF: bl =/= '-'
       ...
       popArgumentStack  rax
       pushArgumentStack rbx     ;; top of ArgumtStack =/= 0, indicating negative
