...
*** implementation
    ...
    : define-variable (* by word-string *)
      (* initial-value, word-string[address, the number of words] -- *)
      head-of-word-string
      define-variable,by-string
      Exit
    ; define-function
    ...
    : define-constant (* by word-string *)
      (* initial-value, word-string[address, the number of words] -- *)
      head-of-word-string
      define-constant,by-string
      Exit
...
*** implementation
    ...
    : append-word-description-to-here,with-if&then
      (* word-string[address, the number of words] -- *)
      dup2 string-full-of-blank? false?branch 3
        drop2 Exit

      tail-and-head-of-word-string

      dup2 Bra:comment equal-string? false?branch 4
...
**** 关于 lambda-calculus
     ...
     3. 在字典比喻下
        ...
        1) define-function & execute-word
        2) lambda & apply
        更一般地
        当再次需要 通过具体化这一对概念
        来设计新的语法和语义 的时候
