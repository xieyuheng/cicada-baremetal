...
**** ABOUT lambda-calculus
     1. lambda is a function which uses two dali
...
**** ABOUT substitution
     ...
     bot NOT a dali or list or wodili
*** data-types
    #+begin_src cicada :tangle english-core.cicada
...
*** note
    1. 对lambda-body的正确求值
       ...
       只要每次lambda的作用都会更新 <lambda> pair 中的约束变元dali
...
*** test
    ...
    λ           (* digests some symbols and a dali in the ArgumentStack,
