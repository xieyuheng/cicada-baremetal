...
* ==================================================
* TODO
  1. >< maybe get rid of "One" "Two" "Three" ...
  ...
  9. 就用户接口的设计而言
     ...
     也就是必须 要先写自己的 文本编辑器
     之后才能考虑窗口 之类的问题
  10. 也许 可以从 isforth 那里 学习在 linux 下写文本编辑器的基本工作
  11. fix the load-file function of linux version
  12. 生成中文字典 交给 Recaler
  13. 支持 windows 及其环境下的开发
  14. 支持 Mac 及其环境下的开发
* ==================================================
* cicada-ideas
