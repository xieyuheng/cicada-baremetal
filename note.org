...
1. new way to use variables
   改常量和变量的使用方式 lambda-calculus 就更方便使用了
...
5. group the functions into groups
...
7. redesign the syntax about chars
   to allow :
   1) 不可打印的字符 还有 关于 utf8 的东西
8. redesign the syntax about strings
   to allow :
   1. 格式输入
