...
use hash-table in assembly to implement
better compiler-semantic
* ==================================================
* ><
  1. as the "debuger" is defined in cicada code
     ...
     - 比如 通常的函数类型的错误
       ...
       来表示函数 所接受的数据类型不对
  2. redesign the syntax about strings
     to allow more
  3. the whole english-core.org needs to be rewrited
  4. ><><>< 注意 ><><><
     对于新的 define 要更改 GC
     整个 GC 都应该被重写了吗 ???
  5. make good use of indentation
